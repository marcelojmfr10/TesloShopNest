...
describe('ProductsService', () => {
    ...
    it('should create a product', async () => {
        ...
        jest.spyOn(productImageRepository, 'create').mockImplementation(
            imageData => imageData as unknown as ProductImage
        );
    ...
    it('should throw a BadRequestException if create product fails', async () => {
        ...
        await expect(service.create(dto, user)).rejects.toThrow('Cannot create product');
    });
    ...
    it('should find a product by valid ID', async () => {
        ...
        expect(result).toEqual({ id: '0caf4236-0763-4c91-9578-3d2acfbf4bcc', title: 'test product' });
    });
    ...
    it('should throw an error if id was not found', async () => {
        ...
        await expect(service.findOne(productId)).rejects.toThrow(`Product with term ${productId} not found`);
